      ...
      <form onSubmit={handleSaveSettings} className="bg-slate-900 border border-slate-800 rounded-2xl p-4 sm:p-5 shadow-md space-y-4">
        ...
        <div className="pt-3 border-t border-slate-800 space-y-3">
          ...
          <div className="max-w-md p-3 bg-slate-950/80 border border-slate-800 rounded-xl space-y-1">
            ...
            <p className="text-[11px] text-slate-400">
              A senha de acesso e usuário desta cantina são cadastrados e redefinidos exclusivamente pelo <strong className="text-white">Administrador Master</strong> para garantir total integridade e segurança. Em caso de perda, solicite a redefinição ao administrador.
            </p>
          </div>
        </div>
